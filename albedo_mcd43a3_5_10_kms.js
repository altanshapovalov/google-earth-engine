...
// 4) Define Buffer Areas ==============================================================
var geometry = pt_collection.geometry();
var buffer5km = geometry.buffer(5000); // 5 km buffer
var buffer10km = geometry.buffer(10000); // 10 km buffer

// 5) Calculate Mean Albedo for Buffer Areas ===========================================
var extractData = function(img) {
  var stats5km = img.reduceRegion({
    geometry: buffer5km,
    scale: 500, // using a scale close to the MODIS resolution
    reducer: ee.Reducer.mean()
  });

  var stats10km = img.reduceRegion({
    geometry: buffer10km,
    scale: 500, // using a scale close to the MODIS resolution
    reducer: ee.Reducer.mean()
  });
  ...
  return ee.Feature(geometry, {
    albedo_5km: stats5km.get('Albedo_BSA_shortwave'),
    albedo_10km: stats10km.get('Albedo_BSA_shortwave'),
